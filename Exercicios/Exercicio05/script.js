...
function adicionar() {
    ...
    num.value = '' // e essa linha é para depois que eu colocar um numero dentro da caixa e clicar em Adicionar, ele automaticamente apaga o conteudo de dentro da caixa.
    num.focus() // O focus é como se eu clica-se novamente dentro da minha caixa para escrever novamente.
}
